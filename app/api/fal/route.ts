    ...
    if (userImageDataUrl) {
      ...
      const r = await (fal.subscribe as any)('fal-ai/flux-pulid', {
        input: {
          ...
          id_weight: 0.8,
          true_cfg: 1,
          negative_prompt: 'ugly, blurry, distorted, cartoon, extra limbs, bad anatomy, watermark, text, low quality, deformed face, unnatural skin, drawing, painting, illustration, 3d render',
